...
LIBSAVED="gdk-pixbuf librsvg libdav libtinfo libgiognutls qemu vte-urlencode-cwd $lib_audio_keywords $lib_browser_launcher"
...
_remove_more_bloatwares() {
	...
	rm -Rf ./"$APP".AppDir/.junest/usr/share/ibus/dicts/emoji*
